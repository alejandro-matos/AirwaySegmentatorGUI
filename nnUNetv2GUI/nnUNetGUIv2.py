...
class nnUNetGUI4(tk.Frame):
    ...
    def create_widgets(self):
        ...
        text_widget = tk.Text(self, wrap='word', height=18, width=100, bg=styles.BG_COLOR, fg="white", font=(styles.FONT_FAMILY, 12), pady=10)
        ...
        text_widget.tag_add("bold", "7.0", "7.end")
        ...
        text_widget.tag_add("center", "7.0", "7.end") 
        text_widget.tag_add("center", "15.0", "15.end") 
        text_widget.tag_configure("center", justify='center')
        text_widget.tag_add("white_text", "1.0", "end")
        text_widget.tag_configure("white_text", foreground="white")
        text_widget.tag_add("link", "5.74", "5.end")
        text_widget.tag_add("bold2", "5.74", "5.end")
        ...
        text_widget.tag_add("link2", "15.0", "15.end")
        text_widget.tag_add("bold2", "15.0", "15.end")
        text_widget.tag_configure("link2", foreground="blue", underline=True)
        ...
        tk.Button(self, text="Run Prediction", command=lambda: self.run_script(), bg='#2196F3', fg='white', width=40).grid(row=roww+5, column=1, sticky="W", padx=30, pady=5)
