...
class nnUNetGUI4(tk.Frame):
    ...
    def setup_paths(self):
        ...
        parent_directory = os.path.dirname(nnUNet_IN)
        nnUNet_OUT = os.path.join(parent_directory, f"{os.path.basename(nnUNet_IN)}_Processed_Images")
    ...
    def create_widgets(self):
        ...
        input_label = tk.Label(self, text="Select Folder:", **label_style).grid(row=2, column=0, **label_grid)
        input_entry = tk.Entry(self, textvariable=self.input_path, width=50)
        input_entry.grid(row=2, column=1, sticky="EW", padx=(0, 10))
        ...
        input_button.grid(row=2, column=2, sticky="W", padx=(10, 10))
